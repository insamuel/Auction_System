...
and buyers and relay the result of the auction. Once the auction has been concluded the server will disconnect the 
seller and buyer clients, restart the auction state and will wait for more incoming connections to start another 
auction.
...
Run example: python3 auc_server.py server_port_number
"""
class auc_server:
    # Server info
